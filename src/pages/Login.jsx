export default function Login() {
  return (
    <div className="rounded-[10px] bg-[#FCFCFC] flex flex-col p-[12px_14.3px_29px_16px] box-sizing-border">
      ...
      <div className="rounded-[12px] bg-[#F1F1F1] relative m-[0_1.7px_10px_0] flex flex-row justify-between p-[17px_16px_17px_20px] w-[calc(100%_-_1.7px)] box-sizing-border">
        <div className="m-[1px_7.5px_0_0] inline-block w-[283.5px] break-words font-['Montserrat'] font-semibold text-[12px] text-[#7F7F7F]">
        Password
        </div>
        <img className="w-[16px] h-[16px]" src="/assets/images/eye-off.png" />
      </div>
      <div className="m-[0_5px_290px_5px] inline-block self-start break-words font-['Montserrat'] font-medium text-[12px] underline text-[#9FB2FF]">
      Forgot your password?
      </div>
      <div className="rounded-[12px] bg-[linear-gradient(270deg,#7B91FF,#95BEFF)] relative m-[0_1.7px_22px_0] flex flex-row justify-center p-[15px_1.7px_15px_0] w-[calc(100%_-_1.7px)] box-sizing-border">
      ...
      <div className="m-[0_2.7px_26px_0] flex flex-row self-center w-[106px] box-sizing-border">
      ...
      <p className="m-[0_2.5px_0_0] self-center break-words font-['Roboto'] font-medium text-[12px]">
      <span>
      Don’t have an account yet? <a href="/signup" className="m-[0_5px_0_5px] underline text-[#9FB2FF]">Create an account</a>
      </span>
      </p>
    </div>
  )
